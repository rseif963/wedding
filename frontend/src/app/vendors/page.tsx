  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <main className="min-h-screen flex flex-col bg-gray-50 overflow-x-hidden">
        ...
        {/* Header */}
        <section
          className="relative text-white py-10 md:py-32 text-center px-2 bg-blur bg-center"
          style={{
                ...
                return (
                  ...
                  >
                    <div className="absolute top-3 left-3 flex gap-2 z-20">
                      {v?.featured && (
                        <div className="bg-yellow-100 text-yellow-800 px-2 py-1 text-xs font-semibold rounded">
                          ⭐ Featured
                        </div>
                      )}
                      {avgRating === 5 && (
                        <div className="bg-green-100 text-green-800 px-2 py-1 text-xs font-semibold rounded">
                          🔥 Top Rated
                        </div>
                      )}
                    </div>
