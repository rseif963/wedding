...
export default function VerificationPage() {
  ...
  const { uploadVerification } = useAppContext();
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      router.push("/vdashboard/onboard/publish");
    } catch (err: any) {
      console.error(err);
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-12 flex items-center gap-3 rounded-xl border border-[#EEEAF6] bg-white px-6 py-5">
          ...
          <div>
            ...
            <div className="text-[14px] text-[#6B5FA7]">
        ...
        <div className="mt-10 rounded-2xl bg-white px-10 py-10 shadow-[0_20px_40px_rgba(59,29,130,0.08)] space-y-6">
          <div className="text-[16px] font-medium text-[#3B1D82]">
            National ID
          </div>
          <p className="text-[15px] text-[#6B5FA7]">
        ...
        <div className="mt-14 flex justify-between items-center">
          ...
          <button
            ...
            className={`rounded-2xl px-14 py-4 text-[16px] font-medium text-white transition
              ${
                canContinue && !loading
